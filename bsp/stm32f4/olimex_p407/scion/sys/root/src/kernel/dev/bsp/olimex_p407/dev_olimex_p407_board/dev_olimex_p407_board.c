...
Global Declaration
=============================================*/
const char dev_olimex_p407_board_name[]="board\0";

int dev_olimex_p407_board_load(void);
int dev_olimex_p407_board_open(desc_t desc, int o_flag);
int dev_olimex_p407_board_close(desc_t desc);
int dev_olimex_p407_board_isset_read(desc_t desc);
int dev_olimex_p407_board_isset_write(desc_t desc);
int dev_olimex_p407_board_read(desc_t desc, char* buf,int size);
int dev_olimex_p407_board_write(desc_t desc, const char* buf,int size);
int dev_olimex_p407_board_seek(desc_t desc,int offset,int origin);
int dev_olimex_p407_board_ioctl(desc_t desc,int request,va_list ap);


dev_map_t dev_olimex_p407_board_map={
   dev_olimex_p407_board_name,
   S_IFBLK,
   dev_olimex_p407_board_load,
   dev_olimex_p407_board_open,
   dev_olimex_p407_board_close,
   dev_olimex_p407_board_isset_read,
   dev_olimex_p407_board_isset_write,
   dev_olimex_p407_board_read,
   dev_olimex_p407_board_write,
   dev_olimex_p407_board_seek,
   dev_olimex_p407_board_ioctl //ioctl
};
...
// uart 3
board_stm32f4xx_uart_info_t olimex_p407_uart_3=
{
...
// spi 3
board_stm32f4xx_spi_info_t olimex_p407_spi_3=
{
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_load
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_open
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_close
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_isset_read
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_isset_write
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_read
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_write
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_olimex_p407_board_ioctl
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*============================================
| End of Source  : dev_olimex_p407_board.c
==============================================*/
