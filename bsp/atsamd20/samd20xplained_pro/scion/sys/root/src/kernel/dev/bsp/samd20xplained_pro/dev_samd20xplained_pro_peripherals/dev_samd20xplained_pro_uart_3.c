...
#include "kernel/dev/arch/cortexm/at91samd20/at91samd20_uart/dev_at91samd20_uart_x.h"

/*===========================================
Global Declaration
=============================================*/
const char dev_samd20xplained_pro_uart_3_name[]="ttys3\0";

static int dev_samd20xplained_pro_uart_3_load(void);
static int dev_samd20xplained_pro_uart_3_open(desc_t desc, int o_flag);
...
dev_map_t dev_samd20xplained_pro_uart_3_map={
   dev_samd20xplained_pro_uart_3_name,
   S_IFCHR,
   dev_samd20xplained_pro_uart_3_load,
   dev_samd20xplained_pro_uart_3_open,
...
/*-------------------------------------------
| Name:dev_samd20xplained_pro_uart_3_load
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_samd20xplained_pro_uart_3_open
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*============================================
| End of Source  : dev_samd20xplained_pro_uart_3.c
==============================================*/
