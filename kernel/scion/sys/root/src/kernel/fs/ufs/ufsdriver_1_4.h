...
| Compiler Directive
==============================================*/
#ifndef _UFSDRIVER_1_4_H
#define _UFSDRIVER_1_4_H
...
typedef int32_t ufs_size_1_4_t; //to do: must be modified to uint32_t to support large file over 16Kbytes.
...
int   _ufs_drv_1_4_drvmakefs     (desc_t desc,superblk_t* psuperblk);
int   _ufs_drv_1_4_drvreadfs     (desc_t desc,superblk_t* psuperblk);
int   _ufs_drv_1_4_drvwritefs    (desc_t desc,superblk_t* psuperblk);
...
int   _ufs_drv_1_4_sync_sp_blk   (mntdev_t* pmntdev,char* pufs_blkalloc,int block_no);
int   _ufs_drv_1_4_sync_sp_node  (mntdev_t* pmntdev,char * pufs_nodealloc,int node_no);
