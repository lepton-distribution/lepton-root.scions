 ...
 */
      ...
      #define __wait_io_int2(__pthread_ptr__, \
                             __timeout__)  ((core_event_timed_wait(KERNEL_IO_INTERRUPT, \
                                                                   __timeout__)<0) ? 0 : -1)
      #define __wait_io_int3(__pthread_ptr__,__timeout__)  core_event_timed_wait( \
      KERNEL_IO_INTERRUPT, __timeout__)
      #define __wait_io_int_abstime(__pthread_ptr__, \
                                    __abs_timeout__) (core_event_timed_wait(KERNEL_IO_INTERRUPT, \
                                                                            __time_s_to_ms(( \
                                                                                              abs_timeout) \
                                                                                           ->tv_sec) \
                                                                            +__time_ns_to_ms(( \
