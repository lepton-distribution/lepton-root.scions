...
Global Declaration
=============================================*/
const char dev_stm32f1xx_uart_s2_name[]="ttys2\0";

int dev_stm32f1xx_uart_s2_load(void);
int dev_stm32f1xx_uart_s2_open(desc_t desc, int o_flag);
...
dev_map_t dev_stm32f1xx_uart_s2_map={
   dev_stm32f1xx_uart_s2_name,
   S_IFCHR,
   dev_stm32f1xx_uart_s2_load,
   dev_stm32f1xx_uart_s2_open,
   ...
   static const _Uart_Descriptor uart_descriptor[] = {
      {USART2, RCC_APB1PeriphClockCmd, RCC_APB1Periph_USART2, USART2_IRQn, DMA1_Channel6, DMA1_Channel6_IRQn, GPIO_TXD2, GPIO_RXD2, &Uart_Ctrl[UART_ID_2]}   // UART_3
   };
   static board_stm32f1xx_uart_info_t stm32f1xx_uart_2;
#else

   static board_stm32f1xx_uart_info_t stm32f1xx_uart_2=
   {
      .uart_descriptor= {USART2, RCC_APB1PeriphClockCmd, RCC_APB1Periph_USART2, USART2_IRQn, DMA1_Channel6, DMA1_Channel6_IRQn, GPIO_TXD2, GPIO_RXD2, &Uart_Ctrl[UART_ID_2]}   // UART_2
   };
#endif
...
{
  uart_irq_handler(&stm32f1xx_uart_2.uart_descriptor);
}
...
/*-------------------------------------------
| Name:dev_stm32f1xx_uart_s2_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_stm32f1xx_uart_s2_load(void) {
   
   #if (__tauon_compiler__==__compiler_keil_arm__)
      memcpy(&stm32f1xx_uart_2.uart_descriptor,&uart_descriptor,sizeof(_Uart_Descriptor));
   #endif
   stm32f1xx_uart_2.uart_descriptor.board_uart_info=&stm32f1xx_uart_2;
   stm32f1xx_uart_2.desc_r=-1;
   stm32f1xx_uart_2.desc_w=-1;
   
   return dev_stm32f1xx_uart_x_load(&stm32f1xx_uart_2);
}
   
/*-------------------------------------------
| Name:dev_stm32f1xx_uart_s2_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_stm32f1xx_uart_s2_open(desc_t desc, int o_flag) {
   return dev_stm32f1xx_uart_x_open(desc, o_flag, &stm32f1xx_uart_2);
}

/*============================================
| End of Source  : dev_stm32f1xx_uart_2.c
==============================================*/