...
Global Declaration
=============================================*/
const char dev_stm32f4xx_uart_3_name[]="ttys3\0";

int dev_stm32f4xx_uart_3_load(void);
int dev_stm32f4xx_uart_3_open(desc_t desc, int o_flag);
...
dev_map_t dev_stm32f4xx_uart_s3_map={
   dev_stm32f4xx_uart_3_name,
   S_IFCHR,
   dev_stm32f4xx_uart_3_load,
   dev_stm32f4xx_uart_3_open,
   ...
   static const _Uart_Descriptor uart_descriptor[] = {
      {USART3, RCC_APB1PeriphClockCmd, RCC_APB1Periph_USART3, USART3_IRQn, DMA1_Stream1, DMA_Channel_4, DMA1_Stream1_IRQn, GPIO_TXD3, GPIO_RXD3, GPIO_AF_USART3, &Uart_Ctrl[UART_ID_3]}   // UART_3
   };
   static board_stm32f4xx_uart_info_t stm32f4xx_uart_3;
#else
...
{
  uart_irq_handler(&stm32f4xx_uart_3.uart_descriptor);
}

void DMA1_Stream1_IRQHandler(void)
{
  uart_dma_irq_handler(&stm32f4xx_uart_3.uart_descriptor);
}

/*-------------------------------------------
| Name:dev_stm32f4xx_uart_3_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_stm32f4xx_uart_3_load(void) {
   ...
   return dev_stm32f4xx_uart_x_load(&stm32f4xx_uart_3);
}
   
/*-------------------------------------------
| Name:dev_stm32f4xx_uart_3_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_stm32f4xx_uart_3_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_uart_x_open(desc, o_flag, &stm32f4xx_uart_3);
}

/*============================================
| End of Source  : dev_stm32f4xx_uart_3.c
==============================================*/