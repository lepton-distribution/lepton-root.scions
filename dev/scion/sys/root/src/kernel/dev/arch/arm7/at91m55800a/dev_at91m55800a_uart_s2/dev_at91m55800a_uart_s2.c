...
void dev_at91m55800a_uart_s2_fifo_pool_rcv(void){
   ...
   if((_at91m55800a_uart_s2_desc_rd>=0) &&
      (_at91m55800a_uart_s2_input_r==_at91m55800a_uart_s2_input_w)) {                                    //empty to not empty
      //profiler
...
void dev_at91m55800a_uart_s2_snd(void){
   ...
   if(_at91m55800a_uart_s2_output_r<_at91m55800a_uart_s2_output_w) {
      ...
      __US_THR2 = snd_data;
   }else if(_at91m55800a_uart_s2_desc_wr>=0 && _at91m55800a_uart_s2_output_r==
            _at91m55800a_uart_s2_output_w) {
...
void dev_at91m55800a_uart_s2_interrupt(void)
{
   ...
   if(dev_at91m55800a_uart_s2_loaded) {
      ...
      } while ( (__US_CSR2 & __US_IMR2 & (0x00000108)) ||
                ( (XMIT) && (__US_CSR2 & __US_IMR2 & (0x00000002)) ) );
