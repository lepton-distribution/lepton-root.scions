...
#define  KINETIS_SDHC_ERRORS_IRQS      (REG_SDHC_IRQSTATEN_DEBESEN_MASK | \
                                        REG_SDHC_IRQSTATEN_DCESEN_MASK | \
                                        REG_SDHC_IRQSTATEN_DTOESEN_MASK | \
                                        REG_SDHC_IRQSTATEN_CIESEN_MASK | \
                                        REG_SDHC_IRQSTATEN_CEBESEN_MASK | \
                                        REG_SDHC_IRQSTATEN_CCESEN_MASK | \
                                        REG_SDHC_IRQSTATEN_CTOESEN_MASK)
...
_sdhc_stat_t g_kinetis_sdhc_stat;
   ...
   #define SDHC_D0 CYGHWR_HAL_KINETIS_PIN(E, 1, 4, \
                                          (PORT_PCR_PS_MASK|PORT_PCR_PE_MASK|PORT_PCR_DSE_MASK))
   #define SDHC_D1 CYGHWR_HAL_KINETIS_PIN(E, 0, 4, \
                                          (PORT_PCR_PS_MASK|PORT_PCR_PE_MASK|PORT_PCR_DSE_MASK))
   #define SDHC_D2 CYGHWR_HAL_KINETIS_PIN(E, 5, 4, \
                                          (PORT_PCR_PS_MASK|PORT_PCR_PE_MASK|PORT_PCR_DSE_MASK))
   #define SDHC_D3 CYGHWR_HAL_KINETIS_PIN(E, 4, 4, \
                                          (PORT_PCR_PS_MASK|PORT_PCR_PE_MASK|PORT_PCR_DSE_MASK))
...
static const unsigned int _kinetis_sdhc_supported_command[] = {
   ...
   REG_SDHC_XFERTYP_CMDINX(2) | REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(
      SDHC_XFERTYP_RSPTYP_136),
   REG_SDHC_XFERTYP_CMDINX(3) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   ...
   REG_SDHC_XFERTYP_CMDINX(SDHC_ACMD6) | REG_SDHC_XFERTYP_CICEN_MASK |
   REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   ...
   REG_SDHC_XFERTYP_CMDINX(7) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),
   REG_SDHC_XFERTYP_CMDINX(8) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(9) | REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(
      SDHC_XFERTYP_RSPTYP_136),
   REG_SDHC_XFERTYP_CMDINX(10) | REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(
      SDHC_XFERTYP_RSPTYP_136),                                                                                  //CMD10
   REG_SDHC_XFERTYP_CMDINX(11) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(12) | REG_SDHC_XFERTYP_CMDTYP(SDHC_XFERTYP_CMDTYP_ABORT) |
   REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(
      SDHC_XFERTYP_RSPTYP_48BUSY),
   REG_SDHC_XFERTYP_CMDINX(13) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   0,
   REG_SDHC_XFERTYP_CMDINX(15) | REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_NO), //CMD15
   REG_SDHC_XFERTYP_CMDINX(16) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(17) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(18) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   0,
   REG_SDHC_XFERTYP_CMDINX(20) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),                                                                                           //CMD20
   0,
   REG_SDHC_XFERTYP_CMDINX(SDHC_ACMD22) | REG_SDHC_XFERTYP_CICEN_MASK |
   REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(SDHC_ACMD23) | REG_SDHC_XFERTYP_CICEN_MASK |
   REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(24) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(25) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),                                                                                           //CMD25
   REG_SDHC_XFERTYP_CMDINX(26) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(27) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(28) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),
   REG_SDHC_XFERTYP_CMDINX(29) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),
   REG_SDHC_XFERTYP_CMDINX(30) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),                                                                                          //CMD30
   0,
   REG_SDHC_XFERTYP_CMDINX(32) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(33) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(34) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(35) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),                                                                                          //CMD35
   REG_SDHC_XFERTYP_CMDINX(36) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(37) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(38) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),
   REG_SDHC_XFERTYP_CMDINX(39) | REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(40) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),                                                                                           //CMD40
   REG_SDHC_XFERTYP_CMDINX(SDHC_ACMD41) | REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(42) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),
   0,
   0,
   0, //CMD45
   ...
   0,
   0, //CMD50
   REG_SDHC_XFERTYP_CMDINX(SDHC_ACMD51) | REG_SDHC_XFERTYP_CICEN_MASK |
   REG_SDHC_XFERTYP_CCCEN_MASK | REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(52) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   REG_SDHC_XFERTYP_CMDINX(53) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),
   0,
   REG_SDHC_XFERTYP_CMDINX(55) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48),                                                                                           //CMD55
   REG_SDHC_XFERTYP_CMDINX(56) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),
   0,
   0,
   0,
   REG_SDHC_XFERTYP_CMDINX(60) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),                                                                                          //CMD60
   REG_SDHC_XFERTYP_CMDINX(61) | REG_SDHC_XFERTYP_CICEN_MASK | REG_SDHC_XFERTYP_CCCEN_MASK |
   REG_SDHC_XFERTYP_RSPTYP(SDHC_XFERTYP_RSPTYP_48BUSY),
   0,
   //ACMD
   0
...
int dev_k60n512_sdhc_open(desc_t desc, int o_flag){
   ...
   if(g_kinetis_sdhc_info._desc_rd>=0 && g_kinetis_sdhc_info._desc_wr>=0) {
      ...
      HAL_WRITE_UINT32(g_kinetis_sdhc_info.sdhc_base + REG_SDHC_IRQSTATEN,
                       KINETIS_SDHC_ALLOWED_IRQS);
...
cyg_uint32 _kinetis_sdhc_isr(cyg_vector_t vector, cyg_addrword_t data) {
   ...
   if((irq_stat & KINETIS_SDHC_ERRORS_IRQS)) {
      ...
      if((irq_stat & REG_SDHC_IRQSTAT_CC_MASK) != 0) {
         ...
         if(p_inf_sdhc->command->block_count > 0) {
            HAL_WRITE_UINT32(g_kinetis_sdhc_info.sdhc_base + REG_SDHC_IRQSIGEN,
                             KINETIS_SDHC_ALLOWED_IRQS);
         }
         else {
      ...
      if(p_inf_sdhc->command->p_resp) {
         ...
         case R2:
            ...
            if(p_inf_sdhc->command->cmd == SEND_CSD) {
               ...
               tmp_val &= 0xff000000;
               p_inf_sdhc->command->p_resp[0] =
                  (p_inf_sdhc->command->p_resp[0] << 8) | (tmp_val >> 24);
               ...
               tmp_val &= 0xff000000;
               p_inf_sdhc->command->p_resp[1] =
                  (p_inf_sdhc->command->p_resp[1] << 8) | (tmp_val >> 24);
               ...
               tmp_val &= 0xff000000;
               p_inf_sdhc->command->p_resp[2] =
                  (p_inf_sdhc->command->p_resp[2] << 8) | (tmp_val >> 24);
