...
Global Declaration
=============================================*/
const char dev_at91sam9260_uart_1_name[]="ttys1\0";

// statics
static int dev_at91sam9260_uart_1_load(void);
static int dev_at91sam9260_uart_1_open(desc_t, int);
static void dev_at91sam9260_uart_1_interrupt(void);

desc_t desc_uart1;

static cyg_handle_t _at91sam9260_uart_1_handle;
static cyg_interrupt _at91sam9260_uart_1_it;
static board_inf_uart_t *p_board_inf_uart_1;   // ADU


// uart_0 Functions pointers
dev_map_t dev_at91sam9260_uart1_map={
   dev_at91sam9260_uart_1_name,
   S_IFCHR,
   dev_at91sam9260_uart_1_load,
   dev_at91sam9260_uart_1_open,
...
/*-------------------------------------------
| Name       : dev_at91sam9260_uart_1_load
...
| See        : -
---------------------------------------------*/
int dev_at91sam9260_uart_1_load (void)
{
   p_board_inf_uart_1  = (board_inf_uart_t *)malloc(sizeof(board_inf_uart_t));
   p_board_inf_uart_1->loaded = 0; // Not loaded

   // Disable all USART interrupts.
   *(AT91C_US1_IDR) = 0xffffffff;

   return dev_at91sam9260_uart_x_load(p_board_inf_uart_1);
}
...
/*============================================
| End of Source  : dev_at91sam9260_uart_1.c
==============================================*/
