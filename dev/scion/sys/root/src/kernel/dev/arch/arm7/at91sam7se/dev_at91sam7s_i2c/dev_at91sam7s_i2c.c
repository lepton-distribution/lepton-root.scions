...
Global Declaration
=============================================*/
const char dev_at91sam7se_i2c_io_name[]="i2c0\0";
...
dev_map_t dev_at91sam7s_i2c_map={
   dev_at91sam7se_i2c_io_name,
   S_IFBLK,
   dev_at91sam7se_i2c_io_load,
   dev_at91sam7se_i2c_io_open,
   dev_at91sam7se_i2c_io_close,
   dev_at91sam7se_i2c_io_isset_read,
   dev_at91sam7se_i2c_io_isset_write,
   dev_at91sam7se_i2c_io_read,
   dev_at91sam7se_i2c_io_write,
   dev_at91sam7se_i2c_io_seek,
   __fdev_not_implemented //ioctl
};

static unsigned char s_i2c_io_init=0;


static kernel_pthread_mutex_t s_i2c_mutex;
//pthread_mutex_t s_i2c_mutex;

#define __dev_i2c_lock()      kernel_pthread_mutex_lock  (&s_i2c_mutex)
#define __dev_i2c_unlock()    kernel_pthread_mutex_unlock(&s_i2c_mutex)

//#define __dev_i2c_lock()      pthread_mutex_lock  (&s_i2c_mutex)
//#define __dev_i2c_unlock()    pthread_mutex_unlock(&s_i2c_mutex)
...
/*-------------------------------------------
| Name:dev_at91sam7se_i2c_io_load
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_at91sam7se_i2c_io_isset_read
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_at91sam7se_i2c_io_isset_write
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_at91sam7se_i2c_io_open
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_at91sam7se_i2c_io_seek
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_at91sam7se_i2c_io_read
...
/*-------------------------------------------
| Name:dev_at91sam7se_i2c_io_write
...
/*============================================
| End of Source  : dev_at91sam7se_i2c_io.c
==============================================*/
