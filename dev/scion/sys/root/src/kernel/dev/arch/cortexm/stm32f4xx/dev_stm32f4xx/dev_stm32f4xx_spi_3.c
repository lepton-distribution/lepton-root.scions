...
Global Declaration
=============================================*/
const char dev_stm32f4xx_spi_3_name[]="spi0\0";

int dev_stm32f4xx_spi_3_load(void);
int dev_stm32f4xx_spi_3_open(desc_t desc, int o_flag);
...
dev_map_t dev_stm32f4xx_spi_3_map={
   dev_stm32f4xx_spi_3_name,
   S_IFCHR,
   dev_stm32f4xx_spi_3_load,
   dev_stm32f4xx_spi_3_open,
   ...
   static const _Spi_Descriptor spi_descriptor[] = {
      {SPI3,  RCC_APB1PeriphClockCmd, RCC_APB1Periph_SPI3,  GPIO_MISO,  GPIO_MOSI,  GPIO_SCK, GPIO_AF_SPI3, 3,  20000000} // SPI_FLASH
   };

   static board_stm32f4xx_spi_info_t stm32f4xx_spi_3;
#else
...
| See:
---------------------------------------------*/
static int dev_stm32f4xx_spi_3_load(void) {
   
   #if (__tauon_compiler__==__compiler_keil_arm__)
      memcpy(&stm32f4xx_spi_3.spi_descriptor,&spi_descriptor,sizeof(_Spi_Descriptor));
   #endif
   stm32f4xx_spi_3.spi_descriptor.board_spi_info=&stm32f4xx_spi_3;
   stm32f4xx_spi_3.desc_r=-1;
   stm32f4xx_spi_3.desc_w=-1;
   
   return dev_stm32f4xx_spi_x_load(&stm32f4xx_spi_3);
}
   
/*-------------------------------------------
| Name:dev_stm32f4xx_spi_3_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_stm32f4xx_spi_3_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_spi_x_open(desc, o_flag, &stm32f4xx_spi_3);
}

/*============================================
| End of Source  : dev_stm32f4xx_spi_3.c
==============================================*/
