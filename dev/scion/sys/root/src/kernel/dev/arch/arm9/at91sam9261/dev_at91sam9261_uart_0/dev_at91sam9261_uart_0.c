...
/**
 * \file
 * implementation du pilote de p�riph�rique pour l'uart 0 de l'arm9 at91sam9261
 * \author bruno mollo
 */
...
#include "dev_at91sam9261_uart_0.h"
...
Global Declaration
=============================================*/
const char dev_at91sam9261_uart_0_name[]="ttys0\0";
...
static void dev_at91sam9261_uart_0_interrupt  (void);
...
// statics
static int dev_at91sam9261_uart_0_load        (void);
int dev_at91sam9261_uart_0_open        (desc_t, int);

desc_t desc_uart_0;

static volatile board_inf_uart_t board_inf_uart_0 __attribute__ ((section (".no_cache")));
static board_inf_uart_t *p_board_inf_uart_0=(void*)0;   // ADU

// uart_0 Functions pointers
dev_map_t dev_at91sam9261_uart_0_map={
   dev_at91sam9261_uart_0_name,
   S_IFCHR,
   dev_at91sam9261_uart_0_load,
   dev_at91sam9261_uart_0_open,
...
/*-------------------------------------------
| Name       : dev_at91sam9261_uart_0_interrupt
...
| See        : -
---------------------------------------------*/
void dev_at91sam9261_uart_0_interrupt(void)
{
   dev_at91sam9261_uart_x_interrupt(p_board_inf_uart_0);
}

/*-------------------------------------------
| Name       : dev_at91sam9261_uart_0_timer_callback
...
| See        : -
---------------------------------------------*/
void dev_at91sam9261_uart_0_timer_callback(void)
{
   dev_at91sam9261_uart_x_timer_callback(p_board_inf_uart_0);
}
#endif

/*-------------------------------------------
| Name       : dev_at91sam9261_uart_0_load
...
| See        : -
---------------------------------------------*/
int dev_at91sam9261_uart_0_load (void)
{
   return dev_at91sam9261_uart_0_load_ex(&board_inf_uart_0);
}
...
| See        : -
---------------------------------------------*/
int dev_at91sam9261_uart_0_load_ex(board_inf_uart_t* p_board_inf_uart){

   if(!p_board_inf_uart)
      p_board_inf_uart_0  = (board_inf_uart_t *)malloc(sizeof(board_inf_uart_t));
   else
      p_board_inf_uart_0  = p_board_inf_uart;

#if defined(__KERNEL_UCORE_EMBOS)
   p_board_inf_uart_0->f_timer_call_back = dev_at91sam9261_uart_0_timer_callback;
#else
   p_board_inf_uart_0->f_timer_call_back = (void*)0;
#endif

   p_board_inf_uart_0->loaded = 0; // Not loaded

   return dev_at91sam9261_uart_x_load (p_board_inf_uart_0);
}



/*-------------------------------------------
| Name       : dev_at91sam9261_uart_0_open
...
| See        : -
---------------------------------------------*/
int dev_at91sam9261_uart_0_open (desc_t desc, int o_flag)
{
   ...
   ((board_inf_uart_t *)ofile_lst[desc].p)->ind_pio_rxd = 9; // PIOC9/RXD0
   ((board_inf_uart_t *)ofile_lst[desc].p)->ind_pio_txd = 8; // PIOC8/TXD0

   //init flag at 0
   ((board_inf_uart_t *)ofile_lst[desc].p)->flag_i_int=0;
   ((board_inf_uart_t *)ofile_lst[desc].p)->flag_o_int=0;
   ...
   if((ofile_lst[desc].nb_reader==0)&&(ofile_lst[desc].nb_writer==0))
   {
      ...
      AT91C_AIC_SVR[AT91C_ID_US0] = (unsigned long)&dev_at91sam9261_uart_0_interrupt;
#elif defined(__KERNEL_UCORE_ECOS)
...
/*============================================
| End of Source  : dev_at91sam9261_uart_0.c
==============================================*/
