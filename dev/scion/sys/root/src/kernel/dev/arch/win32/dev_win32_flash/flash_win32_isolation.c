...
//
static char* pmemory;
static long memory_size = DFLT_FLASH_MEMORYSIZE;
static int fh = -1;

static const char memory[DFLT_FLASH_MEMORYSIZE] = { 0 };
...
static int _flash_make_sector_map(void) {
   ...
   unsigned long dev_sz = DFLT_FLASH_MEMORYSIZE;
...
/*-------------------------------------------
| Name:flash_win32_isolation_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
int flash_win32_isolation_load(const char* path) {
	//
	if (fh == -1) {
      //
...
/*-------------------------------------------
| Name:flash_win32_isolation_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
void* flash_win32_isolation_open(void) {
   //
   instance_counter++;
   //
   return (void*)&dev_flash_am29dlxxxx_win32;
}

/*-------------------------------------------
| Name:flash_win32_isolation_close
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
int flash_win32_isolation_close(void) {
	//
	if (fh == -1)
		return -1;
	//
...
/*------------------------------------------ -
| Name: flash_win32_isolation_read
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_read(int* offset, char* buf, int size) {
	int r;
	//
...
/*------------------------------------------ -
| Name: flash_win32_isolation_write
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_write(int* offset, const char* buf, int size) {
   int w = 0;
   int r = 0;
   int i = 0;
   //
...
/*------------------------------------------ -
| Name: flash_win32_isolation_seek
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_seek(int *offset, int origin) {
   if (*offset >= memory_size)
      return -1;
   //
  *offset = _lseek(fh, *offset, origin);
   //
   return *offset;
}

/*------------------------------------------ -
| Name: flash_win32_isolation_getsize
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_getsize(void) {
	return memory_size;
}

/*------------------------------------------ -
| Name: flash_win32_isolation_setsize
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_setsize(int size) {
	int w;
   //
   _lseek(fh, 0, SEEK_SET);
   //
...
/*------------------------------------------ -
| Name: flash_win32_isolation_getsectorsize
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_getsectorsize(unsigned long sector_addr) {
...
/*------------------------------------------ -
| Name: flash_win32_isolation_erase_sector
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_erase_sector(unsigned long sector_addr) {
   return _flash_erase_sector(sector_addr);
}

/*------------------------------------------ -
| Name: flash_win32_isolation_erase_all
| Description :
| Parameters :
| Return Type :
| Comments :
| See :
-------------------------------------------- - */
int flash_win32_isolation_erase_all(void) {
   return _flash_erase_all();
}
