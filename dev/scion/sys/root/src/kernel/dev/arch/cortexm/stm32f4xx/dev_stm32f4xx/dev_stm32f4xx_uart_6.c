...
dev_map_t dev_stm32f4xx_uart_s6_map={
   ...
   static const _Uart_Descriptor uart_descriptor[] = {
      {USART6, RCC_APB2PeriphClockCmd, RCC_APB2Periph_USART6, USART6_IRQn, DMA1_Stream1, DMA_Channel_4, DMA1_Stream1_IRQn, GPIO_TXD6, GPIO_RXD6, GPIO_AF_USART6, &Uart_Ctrl[UART_ID_6]}   // UART_3
   };
