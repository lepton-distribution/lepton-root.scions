...
#define OS_STACKFILL_CHAR         (0xcdu)                    // To be compatible with IAR stack check plugin
...
//#define OS_USEPARA(para) (void) (para)   // MISRA does not like this version (rule 14.2)
...
*/
  ...
  void OS_TLS_Init(void);          // Initialize Thread Local Storage, OS_TLS.c, CPU specific
                                   // May be replaced by OS_ExtendTaskContext_TLS() in the future
...
extern const struct OS_EXTEND_TASK_CONTEXT_STRUCT OS_NEON_ExtendContext;

/****** Support for ARM VFP *****************************************/

extern const struct OS_EXTEND_TASK_CONTEXT_STRUCT OS_VFP_ExtendContext;

/****** Support for ARM MMU and caches ******************************/

#if (defined (__ARM7A__) && (__CORE__ == __ARM7A__))
  #define OS_ARM_MMU_Enable              OS_ARM_v7A_MMU_Enable
  #define OS_ARM_MMU_InitTT              OS_ARM_v7A_MMU_InitTT
  #define OS_ARM_MMU_AddTTEntries        OS_ARM_v7A_MMU_AddTTEntries

  #define OS_ARM_ICACHE_Enable           OS_ARM_v7A_ICACHE_Enable 
  #define OS_ARM_DCACHE_Enable           OS_ARM_v7A_DCACHE_Enable 
  #define OS_ARM_CACHE_Sync              OS_ARM_v7A_CACHE_Sync
  #define OS_ARM_DCACHE_CleanRange       OS_ARM_v7A_DCACHE_CleanRange
  #define OS_ARM_DCACHE_InvalidateRange  OS_ARM_v7A_DCACHE_InvalidateRange
#else
  #define OS_ARM_MMU_Enable              OS_ARM_v5E_MMU_Enable
  #define OS_ARM_MMU_InitTT              OS_ARM_v5E_MMU_InitTT
  #define OS_ARM_MMU_AddTTEntries        OS_ARM_v5E_MMU_AddTTEntries

  #define OS_ARM_ICACHE_Enable           OS_ARM_v5E_ICACHE_Enable 
  #define OS_ARM_DCACHE_Enable           OS_ARM_v5E_DCACHE_Enable 
  #define OS_ARM_CACHE_Sync              OS_ARM_v5E_CACHE_Sync
  #define OS_ARM_DCACHE_CleanRange       OS_ARM_v5E_DCACHE_CleanRange
  #define OS_ARM_DCACHE_InvalidateRange  OS_ARM_v5E_DCACHE_InvalidateRange
#endif

void OS_ARM_ICACHE_Enable(void);
void OS_ARM_DCACHE_Enable(void);
OS_INTERWORK __arm void OS_ARM_DCACHE_CleanRange     (void* p, unsigned int NumBytes);
OS_INTERWORK __arm void OS_ARM_DCACHE_InvalidateRange(void* p, unsigned int NumBytes);
OS_INTERWORK __arm void OS_ARM_CACHE_Sync(void);
...
OS_INTERWORK __arm void OS_ARM720_CACHE_CleanRange(void* p, unsigned int NumBytes);
OS_INTERWORK __arm void OS_ARM720_CACHE_InvalidateRange(void* p, unsigned int NumBytes);
...
#define OS_VERSION_GENERIC (38801u)       /*  Generic version 3.88a */
