...
| Project: tauon
| Project Manager:
| Source: dev_at91sam9261-ek_lcd.c
| Path: /tauon-project/lepton/sys/user/tauon-basic/src/dev/board_atmel_at91sam9261-ek/dev_at91sam9261-ek_lcd.c        
| Authors: cle_d_anton
| Plateform:
...
static const dev_panel_info_t atmel_at91sam9261_ek_panel_info = {
   ...
   4965000,//4965000,//25000000,    //  vl_pixclock:
